...
The exemple here is a toy example as the `train` dataset does actually contain outcomes. The vignette on [Unsupervised training and fine-tuning](https://mlverse.github.io/tabnet/articles/unsupervised_training.html) will gives you the complete correct workflow step-by-step.
