...
Here we show a **binary classification** exemple of the `attrition` dataset, using a **recipe** for dataset input specification.
...
The exemple here is a toy exemple as the `train` dataset here actually contains outcomes. The vignette on [Unsupervised training and fine-tuning](https://mlverse.github.io/tabnet/articles/unsupervised_training.html) will gives you the complete correct workflow step-by-step.
