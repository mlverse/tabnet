...
## Basic Binary Classification Exemple

Here we show a **binary classification** exemple of the `attrition`
...
The exemple here is a toy exemple as the `train` dataset here actually
contains outcomes. The vignette on [Unsupervised training and
