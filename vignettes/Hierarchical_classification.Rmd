...
The tree only keeps one attribute per tree leaf. Thus in order to transfer your complete predictors dataset into the Node object, you must keep the last level of the hierarchy to be a unique sample identifier (last resort beeing `row_id_to_column()` to achieve it).
