...
```
Hopefully your own hierarchical outcome will have a better success than the one here with `starwars` dataset. But in this journey, you have learn a lot in the data format constraints and solutions, and you now have a new performing solution in your toolbox.
