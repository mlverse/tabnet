...
{tabnet} provides hierarchical outcomes classification capability thanks to a C-HMCN classification head that is used as soon as the dataset is a {data.tree} Node. Lets demonstrate this capability on the `starwars` toy dataset.
